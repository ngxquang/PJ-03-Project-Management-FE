...
const BoardView = ({ id, setIsModalNewTaskOpen }: BoardProps) => {
  ...
  return (
    <DndProvider backend={HTML5Backend}>
      <div className="gird-cols-1 grid gap-4 p-4 md:grid-cols-2 xl:grid-cols-4">
      ...
      >
        {
          task.attachments && task.attachments.length > 0 && (
            <Image 
              src={`https://pm-s3-image-1.s3.ap-southeast-1.amazonaws.com/${task.attachments[0].fileURL}`}
              ...
              <div className="flex -space-x-[6px] overflow-hidden">
                    {task.assignee && (
                      <Image
                        ...
                        src={`https://pm-s3-image-1.s3.ap-southeast-1.amazonaws.com/${task.assignee.profilePictureUrl!}`}
                    ...
                    {task.author && (
                      <Image
                        ...
                        src={`https://pm-s3-image-1.s3.ap-southeast-1.amazonaws.com/${task.author.profilePictureUrl!}`}
